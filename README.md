...
[![NPM version](<https://img.shields.io/npm/v/post-tiktok-captain.svg?label=npm%20(stable)>)](https://npmjs.org/package/post-tiktok-captain) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/post-tiktok-captain)
...
```sh
npm install post-tiktok-captain
```
...
1. Via the `POST_CAPTAIN_LOG` environment variable
...
const client = new PostCaptain({
  logger: logger.child({ name: 'PostCaptain' }),
...
```ts
import PostCaptain from 'npm:post-tiktok-captain';
...
We are keen for your feedback; please open an [issue](https://www.github.com/ulixes/post-captain/issues) with questions, bugs, or suggestions.

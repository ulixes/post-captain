...
```sh
npm install git+ssh://git@github.com:stainless-sdks/post-captain-typescript.git
```
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/post-captain-typescript/issues) with questions, bugs, or suggestions.
